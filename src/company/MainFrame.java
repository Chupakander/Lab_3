...
import	java.awt.BorderLayout;				//границы макета
import	java.awt.Color;
import	java.awt.Dimension;					//измерение
import	java.awt.Toolkit;					//инструментарий
import	java.awt.event.ActionEvent;			//активное событие
...
import	javax.swing.JFileChooser;			//выбор файлов
...
public class MainFrame extends JFrame
{
    ...
    private JMenuItem dataAboutProgramm;
    ...
    public MainFrame(Double[] coefficients)
    {
        ...
        Action infoAboutProgramm = new AbstractAction("О программе")
        {
            ...
            {
                JOptionPane.showMessageDialog(MainFrame.this, "Программу составил студент 6 группы Савченко Матвей", "О программе", JOptionPane.WARNING_MESSAGE);
            }
        };
        dataAboutProgramm = help.add(infoAboutProgramm);
